...
from addons.auth_oauth.controllers.main import OAuthLogin as Home, OAuthController as Controller
    ...
    def list_providers(self):
        ...
        for provider in providers:
            ...
            if 'weixin' in provider['auth_endpoint']:
                ...
                params = dict(
                    response_type='code',
                    appid=wxinfo.appid,  # 你也可以通过provider['client_id']获得，前提是你在界面配置过
                    redirect_uri='https://test2.cyushu.com/wechat/login',  # 微信回调处理url，后面的wechat是我自己添加的，可改，但要与下面的路径一致
